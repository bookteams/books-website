...
CREATE TABLE `book_address`  (
  ...
  `bs_address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '发货地址',
  PRIMARY KEY USING BTREE (`bs_id`),
  INDEX `consumer_address` USING BTREE(`bc_id`),
  CONSTRAINT `consumer_address` FOREIGN KEY (`bc_id`) REFERENCES `book_consumer` (`bc_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
-- ----------------------------
INSERT INTO `book_admin` VALUES (1, 'admin', '141f475cf03e58968c76f73c230a743f');
...
CREATE TABLE `book_attribute`  (
  ...
  `ba_flag` int(11) NOT NULL DEFAULT '' COMMENT '下架',
...
CREATE TABLE `book_consumer`  (
  ...
  `bc_image` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用户头像',
...
INSERT INTO `book_type` VALUES (3, '幼儿教育');
